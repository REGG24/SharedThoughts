<?php
	session_start();
	if(isset($_SESSION["logueado"]) && $_SESSION["logueado"] == TRUE) {//si hay una sesion iniciada entonces entra al admin.php
?>
...
<?php
	} else {//pero si de lo contrario no hay sesión iniciada simplemente entra al index
